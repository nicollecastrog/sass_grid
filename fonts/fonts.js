/*
 ...
 MyFonts Webfont Build ID 2814638, 2014-05-20T03:00:05-0400
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=2814638
 Licensed pageviews: 250,000

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2af2ae";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=1;
...
for(var fonts=[{fontFamily:"GillSansMTStd-MediumItalic",url:wfpath+"2AF2AE_0"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Light",url:wfpath+"2AF2AE_1"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-LightItalic",url:wfpath+"2AF2AE_2"+suffix+"_0."+webfontType},{fontFamily:"GillSansMTStd-Medium",url:wfpath+"2AF2AE_3"+suffix+"_0."+webfontType},{fontFamily:"LevatoPro-Regular",url:wfpath+"2AF2AE_4"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?
